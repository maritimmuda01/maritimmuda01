...
class User extends CI_Controller
{
    ...
    public function ktaold()
    {
        //$data['title'] = 'Kartu Tanda Anggota';   
        // $data['user'] = $this->db->get_where('user', ['email' => $this->session->userdata('email')])->row_array();
        $data['user'] = $this->db->get('user')->result_array();
       
        $this->load->library('pdfgenerator');
        
        $this->data['title_pdf'] = 'Kartu Tanda Anggota';
        
        // $file_pdf = 'Kartu Tanda Anggota';
        //$paper = 'letter';
        //$orientation = "portrait";
        
        $html = $this->load->view('user/kta',$this->data, true);   
    ...
    public function kta()
    {
        ...
        $this->load->view('user/kta', $data);	
    } 

    public function editwpu()
    {
    ...
    public function infobeasiswa(){
        redirect('infobeasiswa');
    }
    public function infokarir(){
        redirect('infokarir');
    }
