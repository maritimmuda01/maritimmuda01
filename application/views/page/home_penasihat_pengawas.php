...
<section class="wow fadeIn">
    <div class="container">
        ...
        <div class="container margin-10px-top">
            ...
            <div class="col-md-3 col-sm-6 col-xs-12 team-block text-left team-style-1 sm-margin-seven-bottom xs-margin-30px-bottom wow fadeInRight" data-wow-duration="900ms" data-wow-delay="0.2s">

                <figure>
                    <div class="team-image xs-width-100">
                        <img src="<?php echo site_url('upload/') ?>user/41/nono1.png" alt="">
                        <div class="overlay-content text-center">
                            <div class="display-table height-100 width-100">
                                <div class="vertical-align-bottom display-table-cell icon-social-small padding-twelve-all">
                    ...
                    <figcaption>
                        <div class="team-member-position margin-20px-top text-center">
                            <div class="text-small font-weight-500 text-extra-dark-gray ">Letjen TNI Marinir (Purn.) Dr. NONO SAMPONO, M.Si.</div>
                            <div class="text-extra-small text-uppercase text-medium-gray">WAKIL KETUA DPD RI</div>
                        </div>
                    </figcaption>
                </figure>
            ...
            <div class="col-md-3 col-sm-6 col-xs-12 team-block text-left team-style-1 sm-margin-seven-bottom xs-margin-30px-bottom wow fadeInRight" data-wow-duration="900ms" data-wow-delay="0.5s">
            ...
            <div class="col-md-3 col-sm-6 col-xs-12 team-block text-left team-style-1 sm-margin-seven-bottom xs-margin-30px-bottom wow fadeInRight" data-wow-duration="900ms" data-wow-delay="0.6s">
                ...
                <figure>
                    ...
                    <figcaption>
                        <div class="team-member-position margin-20px-top text-center">
                            <div class="text-small font-weight-500 text-extra-dark-gray ">Laksamana Pertama TNI Dr. Suradi Agung Slamet, S.T., S.Sos., M.M.</div>
                            <div class="text-extra-small text-uppercase text-medium-gray">Kepala Dinas Potensi Maritim TNI Angkatan Laut</br></br></div>
                        </div>
                    </figcaption>
                </figure>
                    ...
                    <figcaption>
                        <div class="row">
                            <div class="team-member-position margin-20px-top text-center">
                                ...
                                <div class="text-extra-small text-uppercase text-medium-gray">Asisten Deputi Kepeloporan Pemuda, Kemenpora RI</br></br></div>
                            </div>
                        </div>
                    </figcaption>
                </figure>
                    ...
                    <figcaption>
                        <div class="row">
                            <div class="team-member-position margin-20px-top text-center">
                                ...
                                <div class="text-extra-small text-uppercase text-medium-gray">Chairperson of Women in Logistics and Transport (WiLAT) Indonesia</br></br></div>
                            </div>
                        </div>
                    </figcaption>
                </figure>
            ...
            <!-- <div class="col-md-4 col-sm-6 col-xs-12 team-block text-left team-style-1 sm-margin-seven-bottom xs-margin-30px-bottom wow fadeInRight" data-wow-duration="900ms" data-wow-delay="0.4s">
                ...
                <figure>
                    <div class="team-image xs-width-100">
                        <img src="<?php echo site_url('upload/') ?>user/41/putih2.jpeg" alt="">
                        <div class="overlay-content text-center">
                            <div class="display-table height-100 width-100">
                                <div class="vertical-align-bottom display-table-cell icon-social-small padding-twelve-all">
                                    <span class="text-white text-small display-inline-block no-margin"></span>
