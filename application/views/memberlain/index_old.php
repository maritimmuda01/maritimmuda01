            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <form class="" action="" method="" id="form-filter">
                        ...
                        <div class="form-group mb-0">
                            <label for="jns_keanggotaan"></label>
                            <select class="form-control" name="jns_keanggotaan" id="jns_keanggotaan">
                                <option>Pilih</option>
                        ...
                        <div class="form-group d-flex justify-content-end mt-3">
                            ...
                            <button type="submit" class="btn btn-primary btn-sm mx-1"> Temukan Member Lain</button>
                        </div>
                    </form>
                </div>
            </div>
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-hover" id="table_filter" width="100%" cellspacing="0">
                            <thead>
                                <tr>
                                    <!-- <th></th> -->
                                    <th>List Member</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td data-toggle="modal" data-target="#modalProfile<?= $row['id'];?>">

                                        <div class="card mb-3" style="max-width: 540px;">
                                        <div class="row no-gutters">
                                            <div class="col-md-4">
                                                <img src="<?= base_url('assets2/img/profile/'.$row['image']) ?>" class="card-img" alt="...">
                                            </div>
                                            <div class="col-md-8">
                                            <div class="card-body">
